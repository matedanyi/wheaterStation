<?php
  ...
  function getAllReadings($limit) {
    ...
    $sql = "SELECT id, sensor, location, value1, value2, reading_time FROM SensorData order by reading_time desc limit " . $limit;
  ...
  function getLastReadings() {
    ...
    $sql = "SELECT id, sensor, location, value1, value2, reading_time FROM SensorData order by reading_time desc limit 1" ;
    if ($result = $conn->query($sql)) {
